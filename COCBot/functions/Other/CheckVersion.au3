...
Func CheckMODVersion()
	...
	If $sLatestReleaseTag <> $sGitHubModLatestReleaseTag Then
		MsgBox(0, "", "A new version of this mod has been uploaded (" & $sLatestReleaseTag & "), your version may be outdated." & @CRLF & _
		"Check and download the latest version from the help menu.")
		Return False
	EndIf
